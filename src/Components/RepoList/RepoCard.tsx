...
export const RepoCard: React.FC<RepoCardProps>  = ({ handleSelectRepo, repository }) => {
    ...
    return (
        <div className=" md:hover:-translate-y-1 md:hover:scale-105 bg-white border-2 border-gray-300 transition-all rounded-2xl flex p-3 shadow-2xl xl:w-1/2 w-full cursor-pointer" onClick={() => handleSelectRepo(repository)}>
